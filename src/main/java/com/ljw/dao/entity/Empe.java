package com.ljw.dao.entity;

import java.io.Serializable;
import java.sql.Date;

public class Empe implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2830276325448173871L;
	...
	public String toString() {
		return "Empe [empno=" + empno + ", ename=" + ename + ", job=" + job + ", mgr=" + mgr + ", hiredate=" + hiredate
